    ...
    public class CoursesController : ControllerBase
    {
            ...
            JsonPatchDocument<CourseForUpdateDto> patchDocument)
        {
            ...
            if (courseForAuthorFromRepo == null)
            {
                ...
                {
                    return ValidationProblem(ModelState); // triggers validation of that model and any error will end up in  the ModelState
                }
            ...
            // Add validation
            // patchDocument will fail if try to update read-only value or it contains operations on fields that don't allow those operations like
            // adding a filed to static type that doesn't exist
            patchDocument.ApplyTo(courseToPatch, ModelState); // also pass ModelState, any error in validation will make the ModelState invalid
